...
Excess nitrate damages river health by fuelling algal blooms and reducing dissolved oxygen, especially after storm events when runoff pulses into streams. Continuous nitrate sensors are accurate but expensive to purchase, maintain, and clean. As a result, many monitoring programs rely on more affordable routine sensors (e.g., conductivity, turbidity, temperature, dissolved oxygen, and stage).

The practical question I addressed in Assignment 2 is: **Can routine sensors, with local calibration, provide enough information to detect nitrate peaks and guide sampling timing? I also examined where nitrate concentrations tend to be higher, so limited monitoring efforts can be targeted more effectively.**

This blog translates the technical analysis from Assignment 2 into a manager-friendly summary, with one clear figure and one compact table.
